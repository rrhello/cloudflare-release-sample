# GHL Advanced Custom JavaScript Loader — v11

Paste this entire loader into GHL Advanced Custom JavaScript without `<script>`
tags. For preview QA, replace `PREVIEW_HOST` with the immutable deployment host.
...
(function () {
  ...
  var release = "v11";
  var releaseBase = "https://PREVIEW_HOST.rccportal.pages.dev/releases/v11/";
...
After QA and production promotion, change only the base:

```javascript
var releaseBase = "https://rccportal.pages.dev/releases/v11/";
```
