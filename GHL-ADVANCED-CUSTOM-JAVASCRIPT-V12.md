# GHL Advanced Custom JavaScript Loader — v12

Paste this complete loader into GHL Advanced Custom JavaScript without
`<script>` tags. Replace `PREVIEW_HOST` with the immutable QA deployment host.
...
(function () {
  ...
  var release = "v12";
  var releaseBase = "https://PREVIEW_HOST.rccportal.pages.dev/releases/v12/";
...
After QA and production promotion, use:

```javascript
var releaseBase = "https://rccportal.pages.dev/releases/v12/";
```
