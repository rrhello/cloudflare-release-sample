# GHL Advanced Custom JavaScript Loader — v13

Paste this into GHL Advanced Custom JavaScript without `<script>` tags. Replace
`PREVIEW_HOST` with the immutable QA host. Install the companion early CSS from
`GHL-CUSTOM-CSS-INITIAL-PAINT-GUARD-V13.md` at the same time.
...
(function () {
  ...
  var release = "v13";
  var releaseBase = "https://PREVIEW_HOST.rccportal.pages.dev/releases/v13/";
...
```javascript
var releaseBase = "https://rccportal.pages.dev/releases/v13/";
```
