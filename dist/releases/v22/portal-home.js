(function () {
  ...
  function buildDashboard() {
    ...
    var profileToggle = createElement("button", "rcc-profile-actions__toggle", "Account options");
    ...
    profileToggle.dataset.rccProfileToggle = "true";
    profileToggle.setAttribute("aria-expanded", "false");
    profileToggle.setAttribute("aria-controls", "rcc-profile-actions-menu");
    ...
    manageAccount.appendChild(createActionIcon("M12 15.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7ZM19.4 15a1.7 1.7 0 0 0 .34 1.88l.06.06-2 3.46-.08-.02a1.7 1.7 0 0 0-1.8-.14l-.26.15a1.7 1.7 0 0 0-.82 1.69V22h-4v-.09A1.7 1.7 0 0 0 10 20.4l-.26-.15a1.7 1.7 0 0 0-1.8.14l-.08.02-2-3.46.06-.06A1.7 1.7 0 0 0 6.26 15v-.3a1.7 1.7 0 0 0-1.16-1.6L5 13.06V9.07l.1-.04a1.7 1.7 0 0 0 1.16-1.6v-.3a1.7 1.7 0 0 0-.34-1.88l-.06-.06 2-3.46.08.02a1.7 1.7 0 0 0 1.8.14l.26-.15A1.7 1.7 0 0 0 10.82.1V0h4v.09a1.7 1.7 0 0 0 .82 1.69l.26.15a1.7 1.7 0 0 0 1.8-.14l.08-.02 2 3.46-.06.06a1.7 1.7 0 0 0-.34 1.88v.3a1.7 1.7 0 0 0 1.16 1.6l.1.04v3.99l-.1.04a1.7 1.7 0 0 0-1.16 1.6Z"));
    manageAccount.appendChild(createElement("span", "", "Manage Your Account"));
    logout.type = "button";
    ...
    logout.appendChild(createElement("span", "", "Log Out"));
    profileMenu.appendChild(manageAccount);
    profileMenu.appendChild(logout);
    profileCard.appendChild(profileToggle);
    ...
    root.addEventListener("click", function (event) {
      var profileToggle = event.target.closest("[data-rcc-profile-toggle]");
      var accountAction = event.target.closest("[data-rcc-account-action]");
      var actionCard = event.target.closest("[data-rcc-action]");

      if (profileToggle) {
        var menu = root.querySelector("#rcc-profile-actions-menu");
  ...
  function updateDashboard(root) {
    ...
    var profileToggle = root.querySelector("[data-rcc-profile-toggle]");
    var profileAvailable = Boolean(findNativeControl("profile"));
    profileToggle.disabled = !profileAvailable;
    profileToggle.setAttribute("aria-disabled", String(!profileAvailable));
  }
