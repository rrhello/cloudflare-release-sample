(function () {
  ...
  function closeDiscoveryModal() {
    ...
    var modal = document.getElementById("side-bar h-container");
  ...
  function ensureDiscoveryModal(isPrivateGroup) {
    ...
    if (!isPrivateGroup || !modal) {
      document.body.classList.remove("rcc-discovery-modal-open");
      if (backdrop) backdrop.hidden = true;
      return;
    }

    modal.classList.add("rcc-discovery-modal");
    modal.setAttribute("role", "dialog");
    modal.setAttribute("aria-modal", "true");

    heading = modal.querySelector(".hl-text-md-medium");
    if (heading) {
      heading.id = "rcc-discovery-modal-title";
      modal.setAttribute("aria-labelledby", heading.id);
    } else {
      modal.setAttribute("aria-label", "Discover Channels");
    }

    closeButton = modal.querySelector(".rcc-discovery-modal-close");
    if (!closeButton) {
