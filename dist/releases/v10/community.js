(function () {
  ...
  function closeDiscoveryModal() {
    var backdrop = document.getElementById("rcc-discovery-modal-backdrop");
    var modal = document.getElementById("rcc-discovery-modal");

    dismissedDiscoveryPath = window.location.pathname;
    document.body.classList.remove("rcc-discovery-modal-open");
  ...
  function ensureDiscoveryModal(isPrivateGroup) {
    ...
    if (!modal) {
      ...
      modal.id = "rcc-discovery-modal";
      modal.className = "rcc-discovery-modal";
      modal.setAttribute("role", "dialog");
      modal.setAttribute("aria-modal", "true");
      modal.setAttribute("aria-labelledby", "rcc-discovery-modal-title");

      closeButton = document.createElement("button");
      closeButton.type = "button";
      closeButton.className = "rcc-discovery-modal-close";
      closeButton.setAttribute("aria-label", "Close Discover Channels");
      closeButton.textContent = "×";
      closeButton.addEventListener("click", closeDiscoveryModal);

      icon = document.createElement("div");
      icon.className = "rcc-discovery-modal-icon";
      icon.setAttribute("aria-hidden", "true");
      icon.textContent = "🔒";

      heading = document.createElement("h2");
      heading.id = "rcc-discovery-modal-title";
      heading.className = "rcc-discovery-modal-title";
      heading.textContent = "Discover Channels";

      message = document.createElement("p");
      message.className = "rcc-discovery-modal-message";
      message.textContent = "Join this private community to explore its discussions, learning, events, members, and resources.";
    ...
    if (!backdrop) {
      ...
      backdrop.id = "rcc-discovery-modal-backdrop";
      backdrop.className = "rcc-discovery-modal-backdrop";
      backdrop.setAttribute("aria-hidden", "true");
      backdrop.addEventListener("click", closeDiscoveryModal);
      document.body.appendChild(backdrop);
    }

    if (dismissedDiscoveryPath === window.location.pathname) {
      document.body.classList.remove("rcc-discovery-modal-open");
    ...
    document.body.classList.add("rcc-discovery-modal-open");
  }
  ...
  function updatePrivateGroupPage() {
    ...
    ensureDiscoveryModal(isPrivateGroup);
  }
  ...
  document.addEventListener("keydown", function (event) {
    if (event.key === "Escape" && document.body.classList.contains("rcc-discovery-modal-open")) {
      closeDiscoveryModal();
    }
  });
