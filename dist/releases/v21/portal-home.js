(function () {
  ...
  function buildDashboard() {
    ...
    var manageAccount = createElement("button", "rcc-profile-actions__item", "Manage Your Account");
    var logout = createElement("button", "rcc-profile-actions__item rcc-profile-actions__item--logout", "Log Out");
  ...
  function reconcile() {
    if (document.body) {
      document.body.classList.toggle(
        ...
        /^\/courses\/products\/[^/]+/.test(window.location.pathname)
      );
    }
