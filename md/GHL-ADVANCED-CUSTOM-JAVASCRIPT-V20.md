# GHL Advanced Custom JavaScript Loader — v20

Paste this into GHL Advanced Custom JavaScript without `<script>` tags. Replace
`PREVIEW_HOST` with the immutable v20 QA host. Keep the v14 initial-paint Custom
CSS guard.
...
(function () {
  ...
  var release = "v20";
  var releaseBase = "https://PREVIEW_HOST.rccportal.pages.dev/releases/v20/";
