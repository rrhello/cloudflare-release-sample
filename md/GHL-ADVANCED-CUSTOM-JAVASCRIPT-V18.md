# GHL Advanced Custom JavaScript Loader — v18

Paste this into GHL Advanced Custom JavaScript without `<script>` tags. Replace
`PREVIEW_HOST` with the immutable v18 QA host. Keep the v14 initial-paint Custom
CSS guard.
...
(function () {
  ...
  var release = "v18";
  var releaseBase = "https://PREVIEW_HOST.rccportal.pages.dev/releases/v18/";
  ...
  /*
   * GHL can execute this field again after the SPA has already finished.
   * Return before changing ready/loading state when this release is mounted.
   */
  if (existing) return;
